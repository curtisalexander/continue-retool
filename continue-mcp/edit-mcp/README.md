...
remain preferred. UTF-8/UTF-16 BOMs and UTF-8/cp1252/latin-1 encoding round trips
are preserved. Every untouched LF, CRLF, or CR separator remains byte-for-byte
unchanged even in a mixed-line-ending file; replacement breaks reuse the
separators they consume. `replace_all` finds all matches from one snapshot, and
